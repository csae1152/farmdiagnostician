package com.farmdiagnostician.web.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("farmdiagnostician");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("farmdiagnostician");
        ...
        config.getMapConfigs().put("com.farmdiagnostician.web.domain.*", initializeDomainMapConfig(jHipsterProperties));
